...
class HuPulserGui:
    def __init__(self, master):
        ...
        self.Button_activate_ch2 = ToggleButton(pulser_frame, text="Enable", command=self.btn_activate_ch2,
                                                ind_height=12)
        self.Button_activate_ch2.grid(row=4, column=1, padx=5, pady=(5, 0), sticky='E')
        ...
        self.Label_Ch1_Output = tk.Label(pulser_frame, text="Channel 1 output", bg=self.bg_color)
        self.Label_Ch1_Output.grid(row=7, column=0, padx=5, sticky='E')
        self.Led_Ch1_Output = Indicator(pulser_frame)
        self.Led_Ch1_Output.grid(row=7, column=1, padx=5)

        self.Label_Ch2_Output = tk.Label(pulser_frame, text="Channel 2 output", bg=self.bg_color)
        self.Label_Ch2_Output.grid(row=8, column=0, padx=5, sticky='E')
        self.Led_Ch2_Output = Indicator(pulser_frame)
        self.Led_Ch2_Output.grid(row=8, column=1, padx=5)

        self.Button_start = tk.Button(pulser_frame, text="Output", relief=tk.GROOVE, command=self.toggle_output)
        self.Button_start.grid(row=9, column=1, padx=5)
    ...
    def toggle_output(self):
        ...
        self.Led_Ch1_Output.on = self.pulser.output
        self.Led_Ch2_Output.on = self.pulser.output and self.pulser.ch2_enabled
